...
INSERT INTO `dms_language` VALUES ('80', 'menu_cannot_edit', 'Sorry, you can not access the menu', 'en', '1');
INSERT INTO `dms_language` VALUES ('81', 'menu_cannot_edit', '对不起，你没有权限操作该菜单', 'ch', '1');
...
INSERT INTO `dms_menu` VALUES ('3', '设置', 'icon-hamburg-docs', '/Setting/tree/', '1', '0');
...
INSERT INTO `dms_menu` VALUES ('7', '系统设置', 'icon-hamburg-docs', '', '1', '3');
INSERT INTO `dms_menu` VALUES ('8', '菜单管理', 'icon-hamburg-docs', '/Menu/setting/', '1', '7');
INSERT INTO `dms_menu` VALUES ('9', '用户管理', 'icon-hamburg-docs', '/User/setting', '1', '7');
INSERT INTO `dms_menu` VALUES ('10', '部门管理', 'icon-hamburg-docs', '/User/department/', '1', '7');
